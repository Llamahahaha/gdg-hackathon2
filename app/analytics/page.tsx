    ...
    <Card className="pt-0 overflow-hidden">
      <CardHeader className="flex items-center gap-2 space-y-0 border-b border-white/5 py-5 sm:flex-row">
        <div className="grid flex-1 gap-1">
          ...
          <CardDescription>
            Comparative intensity between teams
          </CardDescription>
        </div>
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Sum of player velocities over time
        </CardDescription>
      </CardHeader>
...
export default function AnalyticsPage() {
  ...
  const timelineWithFrame: TimelineFrame[] = timeline.map(
    (frame, i) => ({
      ...frame,
      frame: i,
    })
    ...
    <main className="min-h-screen bg-transparent text-black dark:text-white pt-24 pb-12 px-6 md:px-12 lg:px-16">
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        <div className="space-y-2">
          ...
          <p className="text-gray-500 dark:text-gray-400">
            Advanced interactive visualizations for elite athletic
            performance data.
          </p>
        </div>
          ...
          <Card className="flex flex-col justify-center p-8 bg-gradient-to-br from-[#c8e86e]/10 to-transparent border-[#c8e86e]/20">
            <div className="space-y-4 text-center">
              ...
              <p className="text-xs text-gray-400 leading-relaxed">
                Our AI models are currently processing historical data
                to refine predictive metrics. Expect higher fidelity
                insights as more sessions are logged.
              </p>
            </div>
          </Card>
        </div>
