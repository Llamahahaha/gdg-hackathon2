...
export default function Hero() {
  return (
    <section className="relative h-screen w-full overflow-hidden bg-white dark:bg-black">
      {/* Background Video (Only visible in dark mode or if intended to be always on) */}
      <video
        autoPlay
        loop
        muted
        playsInline
        className="absolute inset-0 h-full w-full object-cover opacity-100 dark:opacity-100 transition-opacity"
      >
        <source
      ...
      {/* Content Overlay */}
      <div className="relative z-10 flex h-full flex-col px-6 md:px-12 lg:px-16 pb-12 lg:pb-16 justify-end bg-gradient-to-t from-white/80 via-transparent to-transparent dark:from-black/80 dark:via-transparent dark:to-transparent">
        ...
        {/* Scroll Indicator */}
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 dark:text-white/40 text-black/40 animate-bounce">
