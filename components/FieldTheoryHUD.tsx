...
const FieldTheoryHUD = () => {
  ...
  const graph = STATES[currentState];

  useEffect(() => {
    let newAlert = "";
    if (currentState === "A") {
      newAlert = "Structural health optimal. High connectivity detected across all zones.";
    } else if (currentState === "B") {
      newAlert = "WARNING: Defensive compression detected. Centrality shifting heavily to GK. Formation stretching.";
    } else if (currentState === "C") {
      newAlert = "CRITICAL: Left-flank cluster disconnected. Formation entropy rising. Recommend immediate shift to 4-4-2 diamond to restore central connectivity.";
    }
  ...
  return (
    <div className="flex h-screen bg-[#0b0f1a] text-white font-sans overflow-hidden">
        ...
        <div className="flex flex-col gap-4">
          {Object.keys(STATES).map((key) => (
            <button
              ...
              className={`group relative p-4 text-left transition-all duration-300 border ${
                currentState === key 
        ...
        <div className="absolute top-0 left-0 right-0 p-8 flex justify-between items-start pointer-events-none z-10">
          ...
          <div className="flex gap-4">
            <div className="liquid-glass px-4 py-2 flex flex-col items-end">
              ...
              <span className="text-xl font-orbitron font-bold text-blue-500">
              ...
              <>
                <div className="space-y-4">
                  ...
                  <div className="flex items-end gap-2">
                    <span className="text-4xl font-orbitron font-bold">0.842</span>
                ...
                <div className="col-span-3 grid grid-cols-3 gap-4">
                  <div className="liquid-glass p-4 space-y-2">
                    ...
                    <div className="text-xl font-orbitron font-bold">1,240m</div>
                  </div>
                  <div className="liquid-glass p-4 space-y-2">
                    <div className="text-[8px] font-black text-white/30 uppercase">Node Density</div>
                    <div className="text-xl font-orbitron font-bold">0.45</div>
                  </div>
                  <div className="liquid-glass p-4 space-y-2">
                    <div className="text-[8px] font-black text-white/30 uppercase">Graph Diameter</div>
                    <div className="text-xl font-orbitron font-bold">4.2</div>
                  </div>
                </div>
              </>
            )}
                ...
                <div className="col-span-3 flex items-center justify-center border border-white/5 bg-black/20 rounded-lg">
                   <div className="flex gap-12">
                      ...
                      <div className="text-center">
                         ...
                         <div className="text-2xl font-orbitron font-bold text-blue-500">±14%</div>
                      </div>
                   </div>
                </div>
              </>
      ...
      <div className="w-96 border-l border-white/5 bg-white/[0.02] backdrop-blur-xl p-6 flex flex-col gap-6">
        <div className="space-y-2">
          <h2 className="text-[10px] font-black tracking-[0.3em] uppercase text-blue-500">Tactical Feed</h2>
